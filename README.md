...
### Files
    ...
    FONT1.inc   Fort font 1. Alphabet.
    FONT2.inc   Fort font 2. Graphics.

    fort.asm    Main
    fort1.asm   Game logic, setup
    fort2.asm   Movement for pods, missiles, tanks, hyper chambers
    fort3.asm   Chopper logic, robot brains
    fort4.asm   Sprite logic, read joystick, draw map
    fort5.asm   Sound generation, sprite updates
    fort6.asm   Data, shapes, display Lists

    FORT7.inc   Variables
    FORT8.inc   Display list for Navatron
...
These were generated by pulling out just the code used to generate them and run on an emulator, then captured in all its 8-bit noisy glory.
    ...
    fort_explosion.aiff         The mega explosion of the Fort Apocalypse
